...
export class HomePage {
  ...
  ionViewWillLeave() {
    ...
    if (this.escuchaRepAnterior) this.pedidoService.listenRepartidorTs(this.escuchaRepAnterior).off('child_added')
  ...
  listenRepartidorPendiente() {
    ...
    this.pedidoService.listenRepartidorTs(this.pedido.id).on('child_added', snapshot => {
      this.ngZone.run(() => {
        const repartidor: RepartidorPedido = snapshot.val();
