...
export class PerfilPage implements OnInit {
  ...
  async guardarCambios() {
    ...
    if (this.perfil.tipo === 'productos' && !this.perfil.formas_pago.efectivo && !this.perfil.formas_pago.tarjeta) {
      this.alertService.presentAlert('', 'Debes agregar por lo menos una forma de pago');
      return;
    }
