...
export class ProductosService {
  ...
  setProducto(producto: Producto, categoria: string, complementos: Complemento[], region: string) {
  ...
  deleteProducto(producto: Producto, tipo: string, categoria: string, region: string) {
    return new Promise(async (resolve, reject) => {
      const idNegocio = this.uidService.getUid();
  ...
  changePasillo(categoria: string, pasilloViejo: string, idProducto: string, region: string) {
    const idNegocio = this.uidService.getUid();
